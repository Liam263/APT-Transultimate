...
interface CreateDepartmentProps extends React.HTMLAttributes<HTMLDivElement> {}
...
export const CreateDepartmentModule = ({
  ...
  const columns: ColumnDef<Department>[] = [
    {
      ...
      cell: ({ row }) => (
        <div className="px-4 w-[500px]">{row.getValue("departmentName")}</div>
      ),
    },
    {
      accessorKey: "status",
  ...
  const departmentMutation = useMutation({
    ...
    onError: (_error, _variables, _context) => {
      setErrMessage("Can't create department, please try again!");
    },
  });
  ...
  return (
    <div>
      <h3 className="font-semibold text-xl">Create department</h3>
      ...
      <ConfirmDialog
        open={showDialog}
        heading="Confirm delete department"
